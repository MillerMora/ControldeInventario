...
-- vendedor_id es NULL desde el inicio para soportar ON DELETE SET NULL
...
-- producto_id es NULL desde el inicio para soportar ON DELETE SET NULL
...
CREATE TABLE IF NOT EXISTS envios (
  ...
  vendedor_id          INT          NULL,
  CONSTRAINT fk_envios_vendedor FOREIGN KEY (vendedor_id)
    REFERENCES usuarios(id) ON DELETE SET NULL
);

-- ============================================================
-- ÍNDICES (FK y columnas de búsqueda frecuente)
-- ============================================================
...
CREATE INDEX idx_vd_producto     ON ventas_detalle (producto_id);
CREATE INDEX idx_envios_vendedor ON envios         (vendedor_id);
...
-- usuario / contraseña: admin/admin123, juanp/pass123, mariacl/pass456 ...
INSERT IGNORE INTO usuarios (nombre, email, usuario, password_hash, rol_id, estado, ultimo_acceso) VALUES
...
INSERT IGNORE INTO productos (referencia, nombre, talla, color, stock_actual, stock_minimo, ubicacion, precio) VALUES
...
INSERT IGNORE INTO ventas (codigo, fecha, total, descuento, estado, cliente, vendedor_id, notas) VALUES
...
INSERT IGNORE INTO ventas_detalle (venta_id, producto_id, talla, cantidad, precio_unit) VALUES
  (1,  1,  'M',     2,  29.99),
  (1,  3,  '42',    2,  39.99),
  (1,  9,  '42-44', 1,   9.99),
  (1,  20, 'L',     1,  19.99),
...
INSERT IGNORE INTO envios (guia, fecha, producto_descripcion, cliente, ciudad_destino, direccion, estado, vendedor_id) VALUES
